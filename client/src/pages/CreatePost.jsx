                                ...
                                <div className="info_container">
                                    <div className="input_feilds">
                                        ...
                                        <input
                                            id='title'
                                            type="text"
                                            placeholder='Property name' name='title' className='form_input border-[1px]  focus:border-custom-green rounded-md placeholder:text-sm '
                                            min={10} max={50}
                                        ...
                                        <textarea
                                            ...
                                            name='description'
                                            className='form_input border-[1px]  focus:border-custom-green rounded-md placeholder:text-sm mt-3'
                                        ...
                                        <div className="property_type">
                                            ...
                                            ">
                                                    <input
                                                        ...
                                                        required
                                                        value={'sale'}
                                                        className="radio w-5 h-5 bg-transparent border border-solid border-gray-400  checked:bg-custom-green checked:border-custom-green dark:checked:bg-white dark:checked:border-custom-green"
                                                        {...register('type')}
                                                    />
                                        ...
                                        <div className="property_info mt-3">
                                            ...
                                            <div className="max-w-[200px] flex items-center justify-between gap-2 mt-2">
                                                ...
                                                <div>
                                                    <input
                                                        defaultValue={550}
                                                        className='border-2 focus:border-custom-green rounded-md max-w-[84px] py-1 px-2 bg-white'
                                                        type="number"
                                                        name="area"
                                                        id="area"
                                            ...
                                            <div className="max-w-[200px]  flex items-center justify-between gap-2 mt-2">
                                                ...
                                                <div>
                                                    <input
                                                        defaultValue={1}
                                                        className='border-2 focus:border-custom-green rounded-md max-w-[84px] min-w-[84px]  py-1 px-2 bg-white'
                                                        min={1} max={10}
                                                        type="number"
                                                        name="beds"
                                                        id="bed"
                                            ...
                                            <div className="form-control">
                                                <label className="label cursor-pointer flex items-center justify-start gap-2">
                                                    <input
                                                        ...
                                                        type="checkbox"
                                                        name='parking'
                                                        className="checkbox w-5 h-5 border-gray-400 rounded-full checked:bg-custom-green"
                                                        {...register('parking')}
                                                    />
                                            ...
                                            <div className="pricing_info flex flex-col">
                                                ...
                                                <div className="flex flex-row mt-2 ">
                                                    ...
                                                    <input
                                                        ...
                                                        type="number"
                                                        name="price"
                                                        className="bg-white p-2 rounded-md text-grey-darkest border-2 focus:border-custom-green font-bold text-red-700 text-lg max-w-[200px]"
                                                ...
                                                <div className="pricing_info flex flex-col">
                                                    ...
                                                    <div className="flex flex-row mt-2 ">
                                                        ...
                                                        <input
                                                            ...
                                                            type="number"
                                                            name="discountPrice"
                                                            className="bg-slate-100 p-2 rounded-md text-grey-darkest border-2 focus:border-custom-green font-bold text-red-700 text-lg max-w-[200px]"
                                ...
                                <div>
                                    ...
                                    <div className="image_upload_container md:p-5 md:border-2 bg-transparent border-dashed rounded-sm md:flex items-center justify-center gap-2">
                                        ...
                                        <input
                                            ...
                                            className={`file-input file:bg-custom-green dark:bg-white bg-red-00 ${loading ? "md:w-4/6" : 'md:w-4/5'} w-full`} />
                                        <button
                                    ...
                                    <div>
                                        ...
                                        <div className="post_btn mt-7">
                                            <button
                                                ...
                                                type='submit'
                                                className="w-full bg-custom-green text-xl tracking-wider font-heading rounded-md hover:opacity-90 disabled:opacity-70 duration-300 text-white p-3">
                                                {
