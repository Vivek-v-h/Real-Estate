                            ...
                            <div className="items_cotainer p-5 py-8 ">
                                <form onSubmit={handleSubmit}>
                                    <div className="form-control w-full max-w-full   sm:max-w-full relative">
                                        ...
                                        />
                                        <button type='submit' className='search_btn   bg-custom-green'>
                                    ...
                                    <div className="feilds_cotainer mt-4">
                                            ...
                                            <div className="control flex flex-row md:flex-col items-center md:items-start xl:flex-row xl:items-center justify-between mt-1">
                                                <div>
                                                    <label className="flex items-center justify-start text-lg font-heading">
                                                        {/* <input
                                                            className=" w-4 h-4 mr-1 bg-transparent border border-solid border-gray-400  checked:bg-custom-green checked:border-custom-green dark:checked:bg-white dark:checked:border-custom-green accent-custom-green dark:bg-transparent"
                                                            type="radio"
                                                            name="type"
                                                            value={"all"}
                                                        ...
                                                        <input
                                                            className="radio w-4 h-4 mr-1 bg-transparent border border-solid border-gray-400 rounded-full checked:bg-custom-green checked:border-custom-green dark:checked:bg-white dark:checked:border-custom-green"
                                                            type="radio"
                                                            name="type"
                                                            value="all"
                                                            onChange={(e) => handleChange(e.target.name, e.target.value)}
                                                ...
                                                <div>
                                                    <label className="flex items-center justify-start text-lg font-heading ">
                                                        <input
                                                            className="radio w-4 h-4 mr-1 bg-transparent border border-solid border-gray-400 rounded-full checked:border-custom-green dark:checked:border-custom-green dark:checked:bg-white checked:bg-custom-green "
                                                            type="radio"
                                                            name="type"
                                                            value={"rent"}
                                                            onChange={(e) => handleChange(e.target.name, e.target.value)}
                                            ...
                                            <div className="aminities_container mt-4">
                                                ...
                                                <div className="control flex flex-row md:flex-col items-center md:items-start xl:flex-row xl:items-center justify-start mt-1">
                                                    <div className='mr-5'>
                                                        <label className="flex items-center justify-start text-lg font-heading">
                                                            <input
                                                                className="checkbox w-[18px] h-[18px] mr-1 border-gray-400 rounded-md checked:bg-custom-green"
                                                                type="checkbox"
                                                                name="parking"
                                        ...
                                        <div className="btn_cotainer w-full">
                                            <button
                                                className='w-full mt-4 py-2 px-2 bg-custom-green text-white rounded-sm hover:bg-custom-green/90'
                        ...
                        <div className="listing_container  md:col-span-9 pb-10 pt-2">
                            {
                                loading
                                    ...
                                    <div className="loading_container mt-40 flex items-center justify-center flex-col">
                                        <FaSearch className='font-xl text-custom-green font-bold text-xl text-center' />
                                        <p className='font-heading text-lg text-center text-custom-green '>Searching...</p>
                                    </div>
                                    :
                                            ...
                                            listings.length !== 0 ?
                                                <>
                                                    ...
                                                    <div className="pageination_part mt-8 md:mt-14 w-full flex items-center justify-center">
                                                        <div className="join">
                                                            ...
                                                            <button
                                                                ...
                                                                className="join-item btn bg-custom-green text-white hover:bg-custom-green/90 
                                                    ...
                                                    "
                                                            ...
                                                            <button
                                                                className="join-item btn bg-custom-green hover:bg-custom-green cursor-default text-white"
                                                            >Page {pageCount}
                                                            </button>
                                                ...
                                                <div className=" mt-40 flex items-center justify-center flex-col">
                                                    <LuSearchX className='font-3xl text-custom-green font-bold text-xl text-center' />
                                                    <p className='font-heading text-lg text-center text-custom-green '>Sorry, Listings not found</p>
                                                </div>
