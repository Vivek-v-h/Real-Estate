    ...
    function SamplePrevArrow({ onClick }) {
        return (
            <div
                ...
                onClick={onClick}
            >
                <BsArrowLeft className='text-custom-green text-lg sm:text-2xl' />
            </div>
        )
    }
    function SampleNextArrow({ onClick }) {
        return (
            <div
                ...
                onClick={onClick}
            >
                <BsArrowRight className='text-custom-green text-lg sm:text-2xl' />
            </div>
        )
    }
        ...
        <>
            {
                loading
                    ...
                    <>
                        <Loading />
                        <p className='text-custom-green text-center font-heading text-xl'>Loading your post…</p>
                    </>
                    :
                            ...
                            <div className="property_details_container pt-4 sm:pt-12 ">
                                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                                    ...
                                    <div className="lg:col-span-7  ">
                                        <div className='bg-white md:p-12 p-6 rounded-md shadow-sm shadow-custom-green'>
                                            <div className="property_info">
                                                <p className='font-heading text-custom-green'>
                                                    <span className='py-2 px-6 bg-custom-green/40 rounded-full border border-custom-green uppercase'>
                                                        {type}
                                                    </span>
                                                </p>
                                                ...
                                                <p className='font-content mt-3 font-medium text-lg flex items-center justify-left'>
                                                    <FaLocationArrow className='text-custom-green' />
                                                    <span className='ml-1'>
                                                        {address}
                                                    </span>
                                                </p>
                                                ...
                                                {
                                                    offer ?
                                                        <p className='text-2xl font-heading text-custom-green mt-5  text-bold'>
                                                            ${discountPrice} <span>
                                                                <s className='text-gray-400 text-sm'>${price}</s>
                                                            </span>
                                                        </p>
                                                        :
                                                        <p className='text-2xl font-heading text-custom-green mt-3  text-bold'>
                                                            ${price}
                                                        </p>
                                                }
                                            </div>
                                            ...
                                            <div className="property_genarel_info grid-cols-3 grid max-w-md">
                                                <p className='font-heading mt-3 font-medium sm:text-lg  text-sm flex items-center justify-left'>
                                                    <FaBed className='text-custom-green' />
                                                    <span className='ml-1'>{bed} Beds</span>
                                                </p>
                                                <p className='font-heading mt-3 font-medium sm:text-lg  text-sm flex items-center justify-left'>
                                                    <FaBath className='text-custom-green' />
                                                    <span className='ml-1'>{bath} Bath</span>
                                                </p>
                                                <p className='font-heading mt-3 font-medium sm:text-lg text-sm flex items-center justify-left'><BiSolidArea className='text-custom-green' />
                                        ...
                                        <div className="property_details mt-8 bg-white rounded-md shadow-sm shadow-custom-green md:px-12 py-5 px-6">
                                            <div
                                            ...
                                            >
                                                <p className='font-heading text-lg sm:text-xl font-extrabold'>Detail & Features</p>
                                                {
                                                    isFeatureActive
                                                        ?
                                                        <i className='p-[5px] rounded-full bg-custom-green/20 flex items-center justify-center'>
                                                            <FaAngleUp className='text-xl text-custom-green' />
                                                        </i>
                                                        :
                                                        <i className='p-[5px] rounded-full bg-custom-green/20 flex items-center justify-center'>
                                                            <FaAngleDown className='text-xl text-custom-green' />
                                                        </i>
                                                }
                                            </div>
                                                        ...
                                                        <div className="grid grid-cols-1 sm:grid-cols-2 sm:gap-5 gap-2 ">
                                                            <div className="btn_container">
                                                                <button
                                                                    ...
                                                                    className='bg-custom-green hover:bg-custom-green/90 text-white w-full px-2 py-3 text-lg font-heading rounded-sm'>
                                                                    Update Post
                                                                </button>
                                                            </div>
...

                                                            {
                                                                currentUser && currentUser.email ?
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        <span className='flex items-center justify-center'>
                                                                            <FaLock className='mr-2 text-custom-green' />
                                                                            Login to Contact
                                                                        </span>
                                                                    </button>
                                                            }
