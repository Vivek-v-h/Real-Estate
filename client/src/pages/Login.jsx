                ...
                currentUser && currentUser.email
                    ...
                    <section className='form-section py-20  '>
                        <div className="container">
                            <p className='text-base md:text-xl text-center text-custom-green font-heading font-bold '>User exist! Redirecting to profile page</p>
                        </div>
                    </section>
                    :
                    <section className='form-section py-10 md:py-20 '>
                        <div className="container ">
                            <div className="form-container px-4 sm:px-8 bg-white py-6 pb-8 sm:py-9 sm:pb-12 max-w-lg mx-auto rounded-sm border-[1px] border-custom-green/50 shadow-brand shadow-custom-green/40">
                                <h1 className='text-left text-custom-green mb-3 font-medium font-heading text-md sm:text-xl'>
                                    {
                                ...
                                <p className="content text-center font-heading text-black mt-4">
                                    ...
                                    <u className='ml-1 border-custom-green text-custom-green cursor-pointer'
