        ...
        <main>
            {
                dataLoading
                    ...
                    <div>
                        <Loading />
                        <p className='font-heading text-custom-green text-lg sm:text-2xl text-center'>Loading...</p>
                    </div>
                    :
                    <section>
                                                ...
                                                <div className="property_info mt-3">
                                                    ...
                                                    <div className="max-w-[200px] flex items-center justify-between gap-2 mt-2">
                                                        ...
                                                        <div>
                                                            <input
                                                                defaultValue={550}
                                                                className='border-2 focus:border-custom-green rounded-md max-w-[84px] min-w-[84px] py-1 px-2 bg-transparent'
                                                                type="number"
                                                                name="area"
                                                                id="area"
                                        ...
                                        <div>
                                            ...
                                            <div className="image_upload_container md:p-5 md:border-2 bg-transparent border-dashed rounded-sm md:flex items-center justify-center gap-2">
                                                ...
                                                <input
                                                    ...
                                                    className={`file-input file:bg-custom-green bg-red-00 ${loading ? "md:w-4/6" : 'md:w-4/5'} w-full`} />
                                                <button
                                                    disabled={loading}
