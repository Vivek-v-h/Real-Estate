          ...
          <div className="profile_info p-5 bg-white  w-full  md:col-span-2 lg:col-span-1  md:max-h-full md:min-h-screen h-full col-span-1 ">
            ...
            <form className='w-full' onSubmit={handleSubmit} >
              <div className='mb-3'>
                <div className="image_container w-full flex items-center justify-center  relative max-w-[100px] mx-auto">
                  ...
                  <input onChange={(e) => setFile(e.target.files[0])}
                    ...
                    ref={fileRef}
                  />
                  <img src={formData.avatar || currentUser.avatar} onClick={() => fileRef.current.click()} className='h-24 w-24 object-cover mb-3 rounded-full border-[1px]  border-custom-green' alt="profile image" />
                  <i className='h-6 w-6 rounded-full flex items-center justify-center bg-custom-green text-white absolute bottom-3 right-0'><AiFillEdit /></i>
                </div>
              ...
              <input
                ...
                className="form_input bg-slate-200 rounded-md !pl-3 mt-1 !border-[1px] focus:!border-custom-green mb-3"
              ...
              <input
                ...
                className="  form_input bg-slate-200 rounded-md !pl-3 !border-[1px] focus:!border-custom-green mb-3"
                onChange={handleChange}
              />
              ...
              <input
                ...
                className="mt-1  form_input bg-slate-200 rounded-md !pl-3 !border-[1px] focus:!border-custom-green"
                onChange={handleChange}
              />

              <button disabled={loading} type='submit' className='py-2 px-5 bg-custom-green text-white rounded-md w-full font-heading  mt-4 hover:opacity-90'>
                {
