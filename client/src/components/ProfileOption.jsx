            ...
            <div className="dropdown dropdown-end">
                <label tabIndex={0} className="btn btn-ghost btn-circle avatar hover:outline-0 hover:border-0">
                    <div className="w-7 rounded-full">
                        <img className='rounded-full border border-custom-green/20 h-8 w-8 object-cover' src={user.avatar} alt="profile image" />
                    </div>
                </label>
                <ul tabIndex={0} className="mt-3 z-[999999999] bg-[#fff] font-heading p-2 shadow menu menu-sm dropdown-content rounded-md w-52 ">
                    <li>
                        <Link to={'/profile'} className="justify-start text-custom-green hover:text-custom-green">
                            <FaUser className='text-custom-green' /> Profile
                        </Link>
                    </li>
                    <li>
                        <Link to={"/saved_listing"} className='hover:text-custom-green'>
                            <FaBookmark className='text-amber-500' /> Saved Listings
                        </Link>
                    </li>
                    <li onClick={handleLogOut}>
                        <Link className='hover:text-custom-green'>
