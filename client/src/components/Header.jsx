...
const Header = () => {
    ...
    return (
        <>
            <div className="navbar pl-0 pr-0 pt-3 pb-3 bg-[#f1dbca] shadow-md">

                <div className="px-5  max-w-screen-2xl w-full !mx-auto grid grid-cols-12 gap-1">
                    {/* Logo container  */}
                    <div className="col-span-3 sm:col-span-4">

                        <h1 className="font-blach sm:text-xl text-sm text-left hover:bg-transparent uppercase text-custom-green tracking-tighter w-full font-heading font-bold flex items-center justify-start">
                    ...
                    <div className="col-span-3 sm:col-span-5  md:col-span-4 flex items-center justify-end">
                        <ul className="hidden sm:ml-5 sm:flex items-center justify-end  pr-4 font-semibold text-custom-green font-content ">
                            <li className='mr-9 capitalize text-xl text-custom-green'>
                                <Link to='/home'>
                                    <FaHome />
                                </Link>
                            </li>

                            <li className='mr-9 capitalize text-lg text-custom-green  '>
                            ...
                            </li>
                            {
                                currentUser ?
                                    ...
                                    :
                                    <li className='mr-6'>
                                        <Link to='/login' className=' text-white px-5 font-bold font-headi py-2 rounded uppercase bg-custom-green text-sm hover:bg-white hover:text-custom-green duration-300 hover:shadow-sm'>
                                            Login
                                        </Link>
                                    </li>
                            }
                        ...
                        <div className="nav_mobile flex items-center justify-center sm:hidden gap-1">
                            ...
                            <Link to={`${currentUser ? "/message" : "/login"}`} className='mr-1 text-lg  text-custom-green'>
                                <span className='relative'>
                                    <BsMessenger className='z-10' />
                                    {
                                        notificationsDB.length === 0
                            ...
                            >
                                {
                                    isActiveMoblie ? <MdOutlineClose className='text-red-600 font-bold' /> : <BsJustifyRight className='text-custom-green' />
                                }
