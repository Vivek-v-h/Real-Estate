                        ...
                        <div className="property_owner mt-10">
                            <div className="image_container flex items-center justify-start gap-2">
                                <img
                                    ...
                                    alt="Property Owner"
                                    className='h-16 w-16 rounded-full border-[1px] shadow-lg border-custom-green'
                                />
                                        ...
                                        '>{responseMsg}</p>
                                            ...
                                            <>
                                                <textarea
                                                    ...
                                                    name='message'
                                                    className='form_input border-[1px] border-gray-400  focus:border-custom-green h-44 rounded-md placeholder:text-sm mt-3'
                                                    onChange={handleChange}
                                                />
                                                <button
                                                    disabled={!message}
                                                    onClick={handleSendMsg}
                                                    className='w-full px-2 py-3 text-lg font-heading text-white bg-custom-green disabled:bg-custom-green/60'>
                                                    Send Messages
                                                </button>
