...
const MobileMenu = ({ menuStatus }) => {
    ...
    return (
        ...
        <menu
            className=' absolute  right-0  bg-white h-72 py-5 px-5 text-custom-green font-semibold  w-full !z-50 shadow-lg shadow-custom-green/40'
        >
            ...
            <ul className=' '>
                <li
                    ...
                    className='p-2 cursor-pointer rounded-sm mb-3  font-heading hover:bg-custom-green/40 duration-300'
                >
                    ...
                    currentUser && currentUser.email
                        ...
                        <>
                            ...
                            <li
                                ...
                                className='p-2  rounded-sm mb-3  cursor-pointer font-heading hover:bg-custom-green/40 duration-300'>
                                <p className='flex items-center gap-2'>
