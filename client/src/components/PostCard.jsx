        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <div className="absolute bottom-3 left-3 inline-flex items-center rounded-sm bg-custom-green px-2 py-1 shadow-md">
                ...
                <div className="p-4">
                    ...
                    >
                        <h2
                            className="text-custom-green font-heading text-xl truncate cursor-pointer">
                            {title}
                        </h2>
                        ...
                        <div className="mt-3 flex items-end justify-between">
                            {offer ?
                                <p className='font-content truncate'>
                                    <span className="text-2xl font-bold font-content text-custom-green ">${discountPrice}</span>
                                    {
                                ...
                                : <p className='font-content truncate'>
                                    <span className="text-2xl font-bold font-content text-custom-green ">${price}</span>
                                    {
                                        type === 'rent' && <span className="text-sm text-slate-700">/m</span>
                                    }
                                </p>}
                    ...
                    <div className='mt-4 flex items-end justify-between'>
                        <button
                            ...
                            className='bg-custom-green rounded-sm py-2 px-7 font-heading text-white hover:opacity-95 text-sm'>
                            Edit
                        </button>
                        <button
