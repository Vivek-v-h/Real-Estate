                ...
                conversation.participantId && conversation.participantId === currentUser._id
                    ...
                    <>
                        <div
                            ...
                            className={`chat_user flex items-center justify-center sm:justify-start sm:flex-row sm:gap-4 hover:bg-custom-green/90 active:bg-custom-green  group w-full p-2 sm:p-3 gap-1 duration-300  cursor-pointer ${trackConversation.conversationActive === conversation.chatCreator._id ? "bg-custom-green text-white" : "bg-gray-200 text-custom-green"}`}
                        >
                            <div className='relative rounded-full'>
                                <img
                                    className='h-8 w-8 sm:h-12 sm:w-12 rounded-full border-2 border-custom-green duration-400 ease-in-out'
                    ...
                    <>
                        <div
                            ...
                            className={`chat_user flex items-center justify-center sm:justify-start sm:flex-row sm:gap-4 hover:bg-custom-green/90 active:bg-custom-green group w-full p-2 sm:p-3 gap-1 duration-300  cursor-pointer 
                        ${trackConversation.conversationActive === conversation.chatPartner._id ? "bg-custom-green text-white" : "bg-gray-200 text-custom-green"}
                        `}
                        >
                            <div className='relative rounded-full'>
                                <img
