...
const ListingCard = ({ listing }) => {
    ...
    return (
        <div className="listing_card bg-white shadow-lg shadow-black/10  hover:shadow-custom-green/20 rounded-sm w-full hover:shadow-lg group sm:mr-auto sm:ml-0 mx-auto">
            <div className="card-container">
                ...
                >
                    ...
                    />
                    <div className="absolute bottom-2 left-2 bg-custom-green py-1 px-2 ">
                ...
                <div className="card_body group-hover:bg-custom-green/5 duration-500  border-x border-b border-custom-green/20 ">

                    <div
                        className="content-container p-3 pb-0 cursor-pointer"
                        onClick={() => navigate(`/listing/${_id}`)}
                    >
                        <h2 className="text-lg font-heading truncate uppercase duration-300 group-hover:text-custom-green ">{title}</h2>
                        <p
                            className='font-content text-xs font-bold truncate flex items-center justify-start mt-1'>
                            <FaLocationArrow className='mr-1 text-custom-green' />
                            {address}
                        </p>
                        ...
                        <div className="info_container mt-4 flex items-center truncate">
                            <p
                                ...
                                <FaBed className='mr-1 text-custom-green' />
                                {bed} Bed
                            </p>
                            <p
                                className='font-content text-xs font-bold truncate flex items-center justify-start ml-4'>
                                <FaBath className='mr-1 text-custom-green' />
                                {bath} Bath
                            </p>
                            <p
                                className='font-content text-xs font-bold truncate flex items-center justify-start ml-4'>
                                <FaChartArea className='mr-1 text-custom-green' />
                                {area} Area
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="listing_footer grid grid-cols-2 align-middle border-t border-custom-green/40 mt-5 p-3 pb-4">

                        <div className="price_container truncate">
                            {offer ?
                                <p className='text-xl font-content text-custom-green font-bold  flex items-center justify-start truncate'>${discountPrice} <s className='text-gray-400  text-xs mt-1 ml-1'>${price}</s> </p>

                                : <p className='text-xl font-content text-custom-green font-bold  flex items-center justify-start truncate'>${price}</p>
                            }
                        </div>
                        <div className="footer_btn flex items-center justify-end mr-1">
                            <button
                                onClick={() => handleSaveListings(_id)}
                                className={`text-lg drop-shadow-sm duration-300  ${heart ? 'text-custom-green' : "text-gray-300"} `}>
